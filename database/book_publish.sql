...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 08, 2026 at 07:00 AM
...
--
-- Table structure for table `book_uploads`
--
...
CREATE TABLE `restricted_words` (
  ...
  `type` enum('profanity','restricted') NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
ALTER TABLE `api_logs`
  ...
  ADD KEY `api_logs_status_code_index` (`status_code`);
...
--
-- Indexes for table `book_uploads`
--
...
ALTER TABLE `book_versions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `book_versions_book_id_index` (`book_id`);
...
--
-- Indexes for table `restricted_words`
--
ALTER TABLE `restricted_words`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `restricted_words_word_unique` (`word`);
...
--
-- AUTO_INCREMENT for table `book_uploads`
--
ALTER TABLE `book_uploads`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `restricted_words`
--
ALTER TABLE `restricted_words`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
